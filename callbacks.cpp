...
bool callbacks::IsChamsSelection0() {
	return g_menu.main.chams.chams_entity_selection.get() == 0;
}

bool callbacks::IsChamsSelection1() {
	return g_menu.main.chams.chams_entity_selection.get() == 1;
}

bool callbacks::IsChamsSelection2() {
	return g_menu.main.chams.chams_entity_selection.get() == 2;
}

bool callbacks::IsChamsSelection3() {
	return g_menu.main.chams.chams_entity_selection.get() == 3;
}
...
bool callbacks::IsDoubleMatEnemy() {
	return g_menu.main.chams.chams_enemy_double.get();
}

bool callbacks::IsDoubleMatTeam() {
	return g_menu.main.chams.chams_friendly_double.get();
}

bool callbacks::IsDoubleMatFake() {
	return g_menu.main.chams.chams_fake_double.get();
}

bool callbacks::IsDoubleMatHistory() {
	return g_menu.main.chams.chams_enemy_history_double.get();
}
...
bool callbacks::MollyRange() {
	return g_menu.main.visuals.proj_range.get(0);
}

bool callbacks::SmokeRange() {
...
bool callbacks::IsGradientScope() {
	return g_menu.main.visuals.no_scope_type.get() == 3;
}

bool callbacks::NoScopeEnabled() {
	return g_menu.main.visuals.removals.get(4);
}

bool callbacks::IsFakePing() {
...
bool callbacks::IsStickman() {
	return g_menu.main.visuals.local_stickman.get();
}

bool callbacks::IsDebugAimOn() {
	return g_menu.main.aimbot.debugaim.get();
}

bool callbacks::IsManualAntiAimOn() {
	return g_menu.main.antiaim.manul_antiaim.get();
}

bool callbacks::OOFArrowsOn() {
