...
public:
	void init() {
		...
		silent.setup(XOR("Silent"), XOR("silent"));
		...
		hitbox_general.setup(XOR("Hitboxes"), XOR("hitbox_general"), { XOR("Head"), XOR("Chest"), XOR("Body"), XOR("Arms"), XOR("Legs"), XOR("Feet") });
		...
		debugaimcol.AddShowCallback(callbacks::IsDebugAimOn);
		RegisterElement(&debugaimcol, 1);

		baim1.setup(XOR("Prefer body aim"), XOR("baim1"), { XOR("Always"), XOR("Lethal"), XOR("Lethal x2"), XOR("Stand"), XOR("In air"), XOR("After x misses") });
		RegisterElement(&baim1, 1);

		baim2.setup(XOR("Force body aim"), XOR("baim2"), { XOR("Always"), XOR("Health"), XOR("Stand"), XOR("In air"), XOR("After x misses") });
	    ...
	    //doubletap_ticks.setup(XOR("Ticks"), XOR("doubletap_ticks"), 10.f, 14.f, false, 0, 14.f, 1.f, XOR(L"t"));
		//doubletap_ticks.AddShowCallback(callbacks::IsDoubleTap);
		//RegisterElement(&doubletap_ticks, 1);

		//slow_teleport.setup(XOR("Expand teleport"), XOR("slow_teleport"));
		//slow_teleport.AddShowCallback(callbacks::IsDoubleTap);
		//RegisterElement(&slow_teleport, 1);

		override_dmg_key.setup(XOR("Minimum damage over-ride"), XOR("override_dmg"));
...
public:
	void init() {
		...
		distortspeed.setup(XOR("Distortion speed"), XOR("distortspeed"), 1.f, 15.f, true, 0, 5.f, 1.f, XOR(L"%"));
		...
		body_fake_stand.setup(XOR("Fake body"), XOR("body_fake_stnd"), { XOR("Off"), XOR("Break logic"), XOR("Random"), XOR("Twist"), XOR("Flap"), XOR("Full"), });
		...
		// col2.
		fake_yaw.setup(XOR("Fake yaw"), XOR("fake_yaw"), { XOR("Off"), XOR("Default"), XOR("Relative"), XOR("Jitter"), XOR("Rotate"), XOR("Random"), XOR("Spin"), XOR("Break 90"), XOR("Break"), XOR("Low delta"), XOR("Delta Breaker"), XOR("Desync Yaw") });
		...
		revoler_disable.setup(XOR("Disable fake-lag with R8"), XOR("revolver_disable"));
		...
		color_manul_antiaim.setup(XOR("Manual anti-aim color"), XOR("color_manul_antiaim"), colors::limegreen);
		color_manul_antiaim.AddShowCallback(callbacks::IsManualAntiAimOn);
		RegisterElement(&color_manul_antiaim, 1);

		draw_angles.setup(XOR("Draw angles"), XOR("draw_angles"));
		RegisterElement(&draw_angles, 1);

		//draw_angles_chams.setup(XOR("Draw fake chams"), XOR("draw_angles_chams"));    //add this back soon
		//RegisterElement(&draw_angles_chams, 1);

		//color_draw_angles_chams.setup(XOR("Fake chams color"), XOR("color_draw_angles_chams"), colors::limegreen);
		...
		backward.setup(XOR("Backwards"), XOR("backwards"));
...
public:
	void init() {
		...
		offscreen_color.AddShowCallback(callbacks::OOFArrowsOn);
		...
		weapon_mode.setup("", XOR("weapon_mode"), { XOR("Text") }, false);
		...
		ammo_color.setup(XOR("Color"), XOR("ammo_color"), colors::limegreen);
		...
		lby_update_color.setup(XOR("Color"), XOR("lby_update_color"), colors::limegreen);
...
public:
	...
	MultiDropdown proj_timer;
	MultiDropdown proj_range;
	Colorpicker   molly_proj_range_color;
	Colorpicker   smoke_proj_range_color;
	...
	Checkbox	  local_stickman;
	Colorpicker   stickman_colour;
...
public:
	void init() {
		...
		item_color.AddShowCallback(callbacks::IsDistanceWeap);
		...
		dropammo_color.AddShowCallback(callbacks::IsDroppedWeapAmmo);
		...
		proj_timer.setup(XOR("projectile timer"), XOR("proj_timer"), { XOR("Bar"), XOR("Text") });
		RegisterElement(&proj_timer);

		proj_range.setup(XOR("Projectile range"), XOR("proj_range"), { XOR("Molly"), XOR("Smoke"), XOR("Nade") });
		RegisterElement(&proj_range);

		molly_proj_range_color.setup(XOR("Molotov color"), XOR("molly_proj_range_color"), { 255, 63, 63, 190 });
		molly_proj_range_color.AddShowCallback(callbacks::MollyRange);
		RegisterElement(&molly_proj_range_color);

		smoke_proj_range_color.setup(XOR("Smoke color"), XOR("smoke_proj_range_color"), { 61, 147, 250, 180 });
		smoke_proj_range_color.AddShowCallback(callbacks::SmokeRange);
		RegisterElement(&smoke_proj_range_color);

		//proj_color.setup(XOR("Color"), XOR("proj_range_color"), colors::burgundy);
	    //RegisterElement(&proj_color);
		...
		gradientcol.setup(XOR("Gradient scope color"), XOR("customscopecolour"), colors::limegreen);
		gradientcol.AddShowCallback(callbacks::IsGradientScope);
		RegisterElement(&gradientcol, 1);

		gradientsize.setup(XOR("Gradient scope size"), XOR("customscopesize"), 1.f, 400.f, true, 0, 200.f, 1.f);
		gradientsize.AddShowCallback(callbacks::IsGradientScope);
		...
		fov_amt.AddShowCallback(callbacks::IsFovVisOn);
		...
		viewmodel_fov_amt.AddShowCallback(callbacks::IsFovViewOn);
		...
		local_stickman.setup(XOR("Local stickman"), XOR("stick man the video game"));
		RegisterElement(&local_stickman, 1);

		stickman_colour.setup(XOR("Stickman color"), XOR("stick man go coloured like nigaer"), { 255, 255, 255 });
		stickman_colour.AddShowCallback(callbacks::IsStickman);
		RegisterElement(&stickman_colour, 1);
		...
		tracers_color.setup(XOR("Grenade simulation color"), XOR("tracers_color"), { 60, 180, 225 });
		tracers_color.AddShowCallback(callbacks::IsSimulationOn);
		...
		impact_beams_time.AddShowCallback(callbacks::IsImpactOn);
...
public:
	void init() {
		...
		cripwalk.setup(XOR("Skatermode"), XOR("cripwalk"));
...
public:
	void init() {
		...
		buy1.setup(XOR("Buy bot"), XOR("auto_buy1"),
			{
				XOR("galilar"),
				XOR("famas"),
				XOR("ak47"),
		...
		notifications.setup(XOR("Logs"), XOR("notifications"), { XOR("Damage") });
		...
		fake_latency_amt.AddShowCallback(callbacks::IsFakePing);
		...
		slide_walk.setup(XOR("Skatewalk"), XOR("slide_walk"));
...
public:
	...
	void init() {
		SetTitle(XOR("Configs"));

		menu_color.setup(XOR("Menu color"), XOR("menu_color"), colors::limegreen, &g_gui.m_color);
		RegisterElement(&menu_color);

		mode.setup(XOR("Safety mode"), XOR("mode"), { XOR("Spread"), XOR("No-spread") });
		RegisterElement(&mode, 1);

		config.setup(XOR("Configuration"), XOR("cfg"), { XOR("Live"), XOR("Cold"), XOR("Canox"), XOR("Skater"), XOR("User"), XOR("Rust") });
...
public:
	...
	Checkbox      chams_local_double;
	Dropdown      chams_local_double_mat;
	Colorpicker   chams_local_double_col;
	Checkbox      chams_local_double_wireframe;
	Slider        chams_local_double_blend;
	...
	Checkbox      chams_friendly_double;
	Dropdown      chams_friendly_double_mat;
	Colorpicker   chams_friendly_double_col;
	Checkbox      chams_friendly_double_wireframe;
	Slider        chams_friendly_double_blend;

	Checkbox      chams_fake;
	Dropdown	  chams_fake_mat;
	Colorpicker   chams_fake_col;
	Checkbox      chams_fake_wireframe;
	Slider        chams_fake_blend;

	Checkbox      chams_fake_double;
	Dropdown      chams_fake_double_mat;
	Colorpicker   chams_fake_double_col;
	Checkbox      chams_fake_double_wireframe;
	Slider        chams_fake_double_blend;
	...
	Checkbox      chams_enemy_history_double;
	Dropdown      chams_enemy_history_double_mat;
	Colorpicker   chams_enemy_history_double_col;
...
public:
	void init() {
		...
		RegisterElement(&chams_local);

		chams_local_mat.setup(XOR("Chams local material"), XOR("chams_local_mat"), { XOR("Material"), XOR("Flat"), XOR("Glass"), XOR("Metallic"), XOR("Shade"), XOR("Glow") });
		chams_local_mat.AddShowCallback(callbacks::IsChamsSelection0);
		RegisterElement(&chams_local_mat);

		chams_local_wireframe.setup(XOR("Wireframe"), XOR("chams_local_wireframe"));
		chams_local_wireframe.AddShowCallback(callbacks::IsChamsSelection0);
		RegisterElement(&chams_local_wireframe);
		...
		RegisterElement(&chams_local_col);
		...
		RegisterElement(&chams_local_blend);
		...
		RegisterElement(&chams_local_scope);
		...
		RegisterElement(&chams_local_scope_blend);

		chams_local_double.setup(XOR("Double chams local"), XOR("chams_local_double"));
		chams_local_double.AddShowCallback(callbacks::IsChamsSelection0);
		RegisterElement(&chams_local_double, 1);

		chams_local_double_mat.setup(XOR("Double chams local material"), XOR("chams_local_double_mat"), { XOR("Outline"), XOR("Glow") });
		chams_local_double_mat.AddShowCallback(callbacks::IsChamsSelection0);
		chams_local_double_mat.AddShowCallback(callbacks::IsDoubleMatLocal);
		RegisterElement(&chams_local_double_mat, 1);

		chams_local_double_wireframe.setup(XOR("Wireframe"), XOR("chams_local_double_wireframe"));
		chams_local_double_wireframe.AddShowCallback(callbacks::IsChamsSelection0);
		chams_local_double_wireframe.AddShowCallback(callbacks::IsDoubleMatLocal);
		RegisterElement(&chams_local_double_wireframe, 1);

		chams_local_double_col.setup(XOR("Color"), XOR("chams_local_double_col"), { 255, 255, 255 });
		chams_local_double_col.AddShowCallback(callbacks::IsChamsSelection0);
		chams_local_double_col.AddShowCallback(callbacks::IsDoubleMatLocal);
		RegisterElement(&chams_local_double_col, 1);

		chams_local_double_blend.setup("", XOR("chams_local_double_blend"), 0.f, 100.f, false, 0, 100.f, 1.f, XOR(L"%"));
		chams_local_double_blend.AddShowCallback(callbacks::IsChamsSelection0);
		chams_local_double_blend.AddShowCallback(callbacks::IsDoubleMatLocal);
		RegisterElement(&chams_local_double_blend, 1);
		...
		chams_enemy_mat.setup(XOR("Chams enemy material"), XOR("chams_enemy_mat"), { XOR("Material"), XOR("Flat"), XOR("Glass"), XOR("Metallic"), XOR("Shade"), XOR("Glow") });
		chams_enemy_mat.AddShowCallback(callbacks::IsChamsSelection1);
		RegisterElement(&chams_enemy_mat);

		chams_enemy_wireframe.setup(XOR("Wireframe"), XOR("chams_friendly_wireframe"));
		chams_enemy_wireframe.AddShowCallback(callbacks::IsChamsSelection1);
		RegisterElement(&chams_enemy_wireframe);
		...
		RegisterElement(&chams_enemy_blend);

		chams_enemy_double.setup(XOR("Double chams enemy"), XOR("chams_enemy_double"));
		chams_enemy_double.AddShowCallback(callbacks::IsChamsSelection1);
		RegisterElement(&chams_enemy_double, 1);

		chams_enemy_double_mat.setup(XOR("Double chams enemy material"), XOR("chams_enemy_double_mat"), { XOR("Outline"), XOR("Glow") });
		chams_enemy_double_mat.AddShowCallback(callbacks::IsChamsSelection1);
		chams_enemy_double_mat.AddShowCallback(callbacks::IsDoubleMatEnemy);
		...
		chams_enemy_double_wireframe.AddShowCallback(callbacks::IsChamsSelection1);
		chams_enemy_double_wireframe.AddShowCallback(callbacks::IsDoubleMatEnemy);
		...
		chams_enemy_double_col.AddShowCallback(callbacks::IsDoubleMatEnemy);
		chams_enemy_double_col.AddShowCallback(callbacks::IsChamsSelection1);
		RegisterElement(&chams_enemy_double_col, 1);

		chams_enemy_double_blend.setup("", XOR("chams_enemy_double_blend"), 0.f, 100.f, false, 0, 100.f, 1.f, XOR(L"%"));
		chams_enemy_double_blend.AddShowCallback(callbacks::IsDoubleMatEnemy);
		chams_enemy_double_blend.AddShowCallback(callbacks::IsChamsSelection1);
		...
		RegisterElement(&chams_friendly);

		chams_friendly_mat.setup(XOR("Chams friendly material"), XOR("chams_friendly_mat"), { XOR("Material"), XOR("Flat"), XOR("Glass"), XOR("Metallic"), XOR("Shade"), XOR("Glow") });
		chams_friendly_mat.AddShowCallback(callbacks::IsChamsSelection2);
		RegisterElement(&chams_friendly_mat);

		chams_friendly_wireframe.setup(XOR("Wireframe"), XOR("chams_friendly_wireframe"));
		chams_friendly_wireframe.AddShowCallback(callbacks::IsChamsSelection2);
		RegisterElement(&chams_friendly_wireframe);
		...
		RegisterElement(&chams_friendly_vis);
		...
		RegisterElement(&chams_friendly_blend);

		chams_friendly_double.setup(XOR("Double chams friendly"), XOR("chams_friendly_double"));
		chams_friendly_double.AddShowCallback(callbacks::IsChamsSelection2);
		RegisterElement(&chams_friendly_double);

		chams_friendly_double_mat.setup(XOR("Double chams friendly material"), XOR("chams_friendly_double_mat"), { XOR("Outline"), XOR("Glow") });
		chams_friendly_double_mat.AddShowCallback(callbacks::IsChamsSelection2);
		chams_friendly_double_mat.AddShowCallback(callbacks::IsDoubleMatTeam);
		RegisterElement(&chams_friendly_double_mat, 1);

		chams_friendly_double_wireframe.setup(XOR("Wireframe"), XOR("chams_friendly_double_wireframe"));
		chams_friendly_double_wireframe.AddShowCallback(callbacks::IsChamsSelection2);
		chams_friendly_double_wireframe.AddShowCallback(callbacks::IsDoubleMatTeam);
		RegisterElement(&chams_friendly_double_wireframe, 1);

		chams_friendly_double_col.setup(XOR("Color"), XOR("chams_friendly_double_col"), { 255, 255, 255 });
		chams_friendly_double_col.AddShowCallback(callbacks::IsChamsSelection2);
		chams_friendly_double_col.AddShowCallback(callbacks::IsDoubleMatTeam);
		RegisterElement(&chams_friendly_double_col, 1);

		chams_friendly_double_blend.setup("", XOR("chams_friendly_double_blend"), 0.f, 100.f, false, 0, 100.f, 1.f, XOR(L"%"));
		chams_friendly_double_blend.AddShowCallback(callbacks::IsChamsSelection2);
		chams_friendly_double_blend.AddShowCallback(callbacks::IsDoubleMatTeam);
		RegisterElement(&chams_friendly_double_blend, 1);

		chams_fake.setup(XOR("Chams fake"), XOR("chams_fake"));
		chams_fake.AddShowCallback(callbacks::IsChamsSelection3);
		RegisterElement(&chams_fake);

		chams_fake_mat.setup(XOR("Chams fake material"), XOR("chams_fake_mat"), { XOR("Material"), XOR("Flat"), XOR("Glass"), XOR("Metallic"), XOR("Shade"), XOR("Glow") });
		chams_fake_mat.AddShowCallback(callbacks::IsChamsSelection3);
		RegisterElement(&chams_fake_mat);

		chams_fake_wireframe.setup(XOR("Wireframe"), XOR("chams_fake_wireframe"));
		chams_fake_wireframe.AddShowCallback(callbacks::IsChamsSelection3);
		RegisterElement(&chams_fake_wireframe);

		chams_fake_col.setup(XOR("Color"), XOR("chams_fake_col"), { 255, 255, 200 });
		chams_fake_col.AddShowCallback(callbacks::IsChamsSelection3);
		RegisterElement(&chams_fake_col);

		chams_fake_blend.setup("", XOR("chams_fake_blend"), 0.f, 100.f, false, 0, 100.f, 1.f, XOR(L"%"));
		chams_fake_blend.AddShowCallback(callbacks::IsChamsSelection3);
		RegisterElement(&chams_fake_blend);

		chams_fake_double.setup(XOR("Double chams fake"), XOR("chams_fake_double"));
		chams_fake_double.AddShowCallback(callbacks::IsChamsSelection3);
		RegisterElement(&chams_fake_double, 1);

		chams_fake_double_mat.setup(XOR("Double chams fake material"), XOR("chams_fake_double_mat"), { XOR("Outline"), XOR("Glow") });
		chams_fake_double_mat.AddShowCallback(callbacks::IsChamsSelection3);
		chams_fake_double_mat.AddShowCallback(callbacks::IsDoubleMatFake);
		RegisterElement(&chams_fake_double_mat, 1);

		chams_fake_double_wireframe.setup(XOR("Wireframe"), XOR("chams_fake_double_wireframe"));
		chams_fake_double_wireframe.AddShowCallback(callbacks::IsChamsSelection3);
		chams_fake_double_wireframe.AddShowCallback(callbacks::IsDoubleMatFake);
		RegisterElement(&chams_fake_double_wireframe, 1);

		chams_fake_double_col.setup(XOR("Color"), XOR("chams_fake_double_col"), { 255, 255, 255 });
		chams_fake_double_col.AddShowCallback(callbacks::IsChamsSelection3);
		chams_fake_double_col.AddShowCallback(callbacks::IsDoubleMatFake);
		RegisterElement(&chams_fake_double_col, 1);

		chams_fake_double_blend.setup("", XOR("chams_fake_double_blend"), 0.f, 100.f, false, 0, 100.f, 1.f, XOR(L"%"));
		chams_fake_double_blend.AddShowCallback(callbacks::IsChamsSelection3);
		chams_fake_double_blend.AddShowCallback(callbacks::IsDoubleMatFake);
		RegisterElement(&chams_fake_double_blend, 1);

		chams_enemy_history.setup(XOR("Chams backtrack"), XOR("chams_history"));
		chams_enemy_history.AddShowCallback(callbacks::IsChamsSelection4);
		RegisterElement(&chams_enemy_history);

		chams_enemy_history_mat.setup(XOR("Chams backtrack material"), XOR("chams_enemy_history_mat"), { XOR("Material"), XOR("Flat"), XOR("Glass"), XOR("Metallic"), XOR("Shade"), XOR("Glow") });
		chams_enemy_history_mat.AddShowCallback(callbacks::IsChamsSelection4);
		RegisterElement(&chams_enemy_history_mat);

		chams_enemy_history_wireframe.setup(XOR("Wireframe"), XOR("chams_enemy_history_wireframe"));
		chams_enemy_history_wireframe.AddShowCallback(callbacks::IsChamsSelection4);
		RegisterElement(&chams_enemy_history_wireframe);

		chams_enemy_history_col.setup(XOR("Color"), XOR("chams_history_col"), { 255, 255, 200 });
		chams_enemy_history_col.AddShowCallback(callbacks::IsChamsSelection4);
		...
		chams_enemy_history_blend.AddShowCallback(callbacks::IsChamsSelection4);
		RegisterElement(&chams_enemy_history_blend);

		chams_enemy_history_double.setup(XOR("Double chams backtrack"), XOR("chams_enemy_history_double"));
		chams_enemy_history_double.AddShowCallback(callbacks::IsChamsSelection4);
		RegisterElement(&chams_enemy_history_double, 1);

		chams_enemy_history_double_mat.setup(XOR("Double chams backtrack material"), XOR("chams_enemy_history_double_mat"), { XOR("Outline"), XOR("Glow") });
		chams_enemy_history_double_mat.AddShowCallback(callbacks::IsChamsSelection4);
		chams_enemy_history_double_mat.AddShowCallback(callbacks::IsDoubleMatFake);
		RegisterElement(&chams_enemy_history_double_mat, 1);

		chams_enemy_history_double_wireframe.setup(XOR("Wireframe"), XOR("chams_enemy_history_double_wireframe"));
		chams_enemy_history_double_wireframe.AddShowCallback(callbacks::IsChamsSelection4);
		chams_enemy_history_double_wireframe.AddShowCallback(callbacks::IsDoubleMatFake);
		RegisterElement(&chams_enemy_history_double_wireframe, 1);

		chams_enemy_history_double_col.setup(XOR("Color"), XOR("chams_enemy_history_double_col"), { 255, 255, 255 });
		chams_enemy_history_double_col.AddShowCallback(callbacks::IsChamsSelection4);
		chams_enemy_history_double_col.AddShowCallback(callbacks::IsDoubleMatFake);
		RegisterElement(&chams_enemy_history_double_col, 1);

		chams_enemy_history_double_blend.setup("", XOR("chams_enemy_history_double_blend"), 0.f, 100.f, false, 0, 100.f, 1.f, XOR(L"%"));
